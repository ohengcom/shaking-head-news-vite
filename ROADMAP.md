...
This roadmap focuses on making Shaking Head News easier to try, self-host, and contribute
to.
...
- Optional entitlement-provider examples for the self-hosted Pro preview.
- More deployment examples for custom domains and multiple environments.
- Better observability examples for production Workers.
- More source adapters for curated hot lists.

## Not Planned

- Built-in billing.
- Medical diagnosis, treatment, or health-outcome claims.
